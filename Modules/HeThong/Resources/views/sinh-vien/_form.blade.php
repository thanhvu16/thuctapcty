    ...
    <div class="box-body">
        ...
        <div class="form-group col-md-9">
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    <label for="username" class="col-form-label">Mã sinh viên <i>(Là tài khoản đăng nhập)</i> @include('admin::required')</label>
                    <input type="text" id="username" name="username"
                           class="form-control @error('username') is-invalid @enderror"
                           placeholder="Nhập Mã sinh viên"
...
{{--                @if (auth::user()->hasRole(QUAN_TRI_HT))--}}
                    ...
                    <div class="form-group col-md-4">
                        <label class="col-form-label" for="quyen-han">Khoa <span
                                style="color: red">*</span></label>
                    ...
                    <div class="form-group col-md-4">
                        <label class="col-form-label" for="quyen-han">Giảng viên hướng dẫn <span
                                style="color: red">*</span></label>
                        <select class="form-control select2" name="giang_vien" required>
                    ...
                    <div class="form-group col-md-4">
                        <label class="col-form-label" for="quyen-han">Doanh nghiệp <span
                                style="color: red">*</span></label>
                        <select class="form-control select2" name="doanh_nghiep" required>
