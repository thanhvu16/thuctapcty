    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <div class="col-md-7 pl-1">
                ...
                <a class="text-title-item" href="{{ route('thu-ky.index') }}">
                    ...
                    <a class="text-title-item" href="{{ route('danhSachDaDuyet') }}">
                        <p>Bài viết đã duyệt
                            <button
                                class="btn br-10 btn-warning btn-circle waves-effect waves-light btn-sm pull-right count-item">{{ $baiVietDaDuyet }}</button>
                        </p>
                    </a>
